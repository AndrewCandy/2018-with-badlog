...
import frc.robot.XBoxTriggerButton;
...
public class OI {
	...
	public OI() {
		...
		armPos0Button.whenPressed(new DockWithDistance());
	...
	public double getArcadeDrive() {
		double Y = Utilities.joystickDeadband(this.driverController.getRawAxis(0), 0.05);
		return Y;
	}

	public double getRawLeftTrigger() {
		double Y = Utilities.joystickDeadband(this.driverController.getRawAxis(2), 0.05);
		return Y;
	}

	public double getRawRightTrigger(){
		double Y = Utilities.joystickDeadband(this.driverController.getRawAxis(3), 0.05);
		return Y;
	}
