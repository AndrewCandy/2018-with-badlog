...
public class Drive extends Command {
	...
	/* double driveVal = Robot.oi.getRawRightTrigger()-robot.oi.getRawLeftTrigger();
	double turnVal = Robot.oi.getArcadeDrive()/2;


		left = driveVal + turnVal;
		right = driveVal - turnVal;
 */
